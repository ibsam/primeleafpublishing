        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="global_content">
                    ...
                    <p>Do you want us to write on your behalf? Get in touch with us. Provide all the details regarding your project, and we will provide you with exceptional writing services – par excellence - to ensure total satisfaction.</p>
                    <ul>
                        <li>
                            <span>
                            ...
                            <span>
                                <h5>Toll Free </h5>
                                <a href="tel:+0 000 000 0000">+0 000 000 0000</a>
                            </span>
                        </li>
                        <li>
                            <span>
            ...
            <div class="col-md-4">
                <div class="form_inner">
                    <form action="/thank-you/" method="POST">
                        ...
                        <input type="tel"  name="phone" placeholder="Phone number *" required oninvalid="this.setCustomValidity('Please Enter Your Full Phone Number')" maxlength="12" minlength="12" >
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="footer_logo">
                    <a href="/"><img src="assets/images/logo.webp" alt="" width="100%" height="100%"></a>
                    <p>A dedicated publishing house committed to empowering authors with exceptional quality and personalized support.</p>
                </div>
            </div>
            <div class="col-md-4">
              ...
              <div class="col-md-6">
                <div class="popup_form_wrp">
                  ...
                  <form action="/thank-you/" method="POST">          
                      ...
                      <input type="tel" name="phone" placeholder="Phone Number" required maxlength="12" minlength="12"  oninvalid="this.setCustomValidity('Please Enter Your Full Phone Number')">
